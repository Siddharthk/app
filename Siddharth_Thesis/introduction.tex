...
\includegraphics[height=1.1in, width=2in]{chap1/orig.eps}
\label{fig:subfig11}
}\\
\subfigure[Red]{
\includegraphics[height=1.1in, width=1.95in]{chap1/r.eps}
\label{fig:subfig12}
}
\subfigure[Green]{
\includegraphics[height=1.1in, width=1.95in]{chap1/g.eps}
\label{fig:subfig11}
}
\subfigure[Blue]{
\includegraphics[height=1.1in, width=1.95in]{chap1/b.eps}
\label{fig:subfig13}
}
\\
%\hspace*{1.5in}
\subfigure[Hue]{
\includegraphics[height=1.1in, width=1.95in]{chap1/h.eps}
\label{fig:subfig13}
}
\subfigure[Saturation]{
\includegraphics[height=1.1in, width=1.95in]{chap1/s.eps}
\label{fig:subfig12}
}
\subfigure[Intensity]{
\includegraphics[height=1.1in, width=1.95in]{chap1/v.eps}
\label{fig:subfig13}
}
%\\
% \hspace*{1.5in}
